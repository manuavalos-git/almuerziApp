...
const controlSubmit=()=>{
    ...
    orderForm.onsubmit=(evento)=>{
        ...
        fetch("https://almuerzi-backend-cp1zvz6kj-manuavalos-git.vercel.app/api/orders",{
            method: 'POST',
            headers: {
...
const controlDatos=()=>{
    fetch("https://almuerzi-backend-cp1zvz6kj-manuavalos-git.vercel.app/api/meals")
...
const renderRegister=()=>{
    ...
    registerForm.onsubmit=(evento)=>{
        ...
        if(validationRegister()){
            fetch("https://almuerzi-backend-cp1zvz6kj-manuavalos-git.vercel.app/api/auth/register",{
                method: 'POST',
                headers: {
                'Content-Type': 'application/json'
                },
...
const renderLogin=()=>{
    ...
    loginForm.onsubmit=(evento)=>{
        ...
        fetch("https://almuerzi-backend-cp1zvz6kj-manuavalos-git.vercel.app/api/auth/login",{
        method: 'POST',
        headers: {
        'Content-Type': 'application/json'
        },
        ...
        .then(token=>{
            return fetch("https://almuerzi-backend-cp1zvz6kj-manuavalos-git.vercel.app/api/auth/me",{
                method:'GET',
                headers:{
                    'Content-Type':'application/json',
                    authorization:token
